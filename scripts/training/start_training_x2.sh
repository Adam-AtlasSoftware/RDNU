...
# Use GPUs 0, 1, 2, and 3 (the RTX 3090s)
...
/home/adam/2tb-workspace/RDNU/environments/env310/bin/python -m torch.distributed.run \
    ...
    --master_port=29506 \
    basicsr/train.py \
    -opt options/train/train_RDG-s_x2.yml \
    --launcher pytorch --auto_resume > ../training_outputs/training_output_x2.log 2>&1 &

echo "Training started in background! Check training_outputs/training_output_x2.log for progress."