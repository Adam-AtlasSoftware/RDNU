// Generated by runtime/tools/port_nss_shaders.py from Arm's ffx_nss_depth_scatter.h (MIT).
...
static const float kDepthIntScale           = 2147483647.0;
static const float kBilinearWeightThreshold = 0.1;
