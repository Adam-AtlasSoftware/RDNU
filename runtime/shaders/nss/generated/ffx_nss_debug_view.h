// Generated by runtime/tools/port_nss_shaders.py from Arm's ffx_nss_debug_view.h (MIT).
...
Texture2D<float4> r_luma_deriv : RDNU_REG_T(NSS_BIND_SRV_LUMA_DERIV);
...
float4 SampleDebugTile(int32_t tileX, int32_t tileY, float2 tileUV)
{
    ...
    if (tileY == 0)
    {
        if (tileX == 0)
        {
            // History color from previous-frame upscaled textureSample(output resolution).
