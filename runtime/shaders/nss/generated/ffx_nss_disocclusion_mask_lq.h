// Generated by runtime/tools/port_nss_shaders.py from Arm's ffx_nss_disocclusion_mask_lq.h (MIT).
...
RWTexture2D<float4> rw_disocclusion_mask_lq : RDNU_REG_U(NSS_BIND_UAV_DISOCCLUSION_MASK_LQ);
...
static const float kNssLqDisocclusionEps             = 1e-7;
static const float kNssLqDisocclusionDepthScale      = 2147483647.0;
static const float kNssLqDisocclusionInvDepthScale   = 1.0 / kNssLqDisocclusionDepthScale;
static const float kNssLqDisocclusionMotionThreshold = 0.1;
