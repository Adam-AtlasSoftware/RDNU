// Generated by runtime/tools/port_nss_shaders.py from Arm's ffx_nss_generate_offset_lut.h (MIT).
...
RWTexture2D<uint4> rw_offset_lut : RDNU_REG_U(NSS_BIND_UAV_OFFSET_LUT);

#if NSS_FILTER_MODE == 3
static const int32_t  kPackedTapCount                     = 4;
static const int32_t  kLutGroupCount                      = 1;
static const int32_t  kCandidateCount                     = 16;
static const int32_t  kCandidateLinear[kCandidateCount]   = {5, 1, 4, 6, 9, 0, 2, 8, 10, 7, 13, 3, 11, 12, 14, 15};
static const int32_t2 kCandidateOffsetYx[kCandidateCount] = {int32_t2(0, 0),
                                                                               int32_t2(0, -1),
                                                                               int32_t2(-1, 0),
                                                                               int32_t2(1, 0),
                                                                               int32_t2(0, 1),
                                                                               ...
                                                                               int32_t2(2, 2)};
#else
static const int32_t kPackedTapCount                   = 9;
static const int32_t kLutGroupCount                    = 3;
static const int32_t kCandidateCount                   = 36;
static const int32_t kCandidateLinear[kCandidateCount] = {
