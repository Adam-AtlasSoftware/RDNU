...
def prepare_keys_gameir(folder_path):
    import os
    print(f'Reading image path list for {folder_path} ...')
    img_path_list = []
    keys = []
    for root, _, files in os.walk(folder_path):
        for file in sorted(files):
            if file.endswith('.png') or file.endswith('.exr') or file.endswith('.json'):
...
def create_lmdb_for_gameir():
    # Train
    folder_path = '/home/adam/workspace/RDNU/GameIR/mini_dataset/train/GameIR-SR/GameIR-SR'
    lmdb_path = '/home/adam/workspace/RDNU/GameIR/mini_dataset/train/GameIR-SR_train.lmdb'
    img_path_list, keys = prepare_keys_gameir(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=False)

    # Test
    folder_path_test = '/home/adam/workspace/RDNU/GameIR/mini_dataset/test/GameIR-SR/GameIR-SR'
    lmdb_path_test = '/home/adam/workspace/RDNU/GameIR/mini_dataset/test/GameIR-SR_test.lmdb'
    img_path_list, keys = prepare_keys_gameir(folder_path_test)
    make_lmdb_from_imgs(folder_path_test, lmdb_path_test, img_path_list, keys, multiprocessing_read=False)
